    ...
    <div className="w-full max-w-7xl mx-auto px-6 md:px-12 lg:px-16">
      <div className="grid lg:grid-cols-12 gap-20 items-center">
        <div className="lg:col-span-5 relative">
          ...
          {/* Experience Badge */}
          <div className="absolute -bottom-8 -right-4 md:-right-8 p-8 md:p-12 bg-indigo-600 text-white rounded-[2.5rem] shadow-2xl hidden sm:block border-8 border-white transform hover:rotate-3 transition-transform cursor-default">
            <div className="text-4xl md:text-5xl font-black mb-1 tracking-tighter">15+</div>
        ...
        <div className="lg:col-span-7">
          ...
          <h3 className="text-5xl lg:text-7xl font-bold text-slate-950 mb-10 leading-none tracking-tighter">
            {t.title} <br />
          ...
          <div className="mt-14 flex flex-wrap gap-12">
            <div className="flex flex-col">
              ...
              <span className="font-black text-slate-950 text-xs tracking-wider">B.COMM, ACCOUNTING</span>
            </div>
            <div className="flex flex-col">
              <span className="text-[9px] uppercase tracking-[0.3em] text-slate-400 font-black mb-3">{t.cert}</span>
              <span className="font-black text-slate-950 text-xs tracking-wider">CPA • CGA (CAN)</span>
            </div>
          </div>
          ...
          <div className="mt-16 flex items-center gap-6">
            <a 
              ...
              className="inline-flex items-center gap-4 px-10 py-5 bg-[#0077b5] text-white rounded-full font-black text-xs uppercase tracking-widest hover:bg-slate-950 transition-all hover:shadow-2xl active:scale-95 shadow-lg"
            >
              <Linkedin size={18} />
              {t.linkedin}
            </a>
