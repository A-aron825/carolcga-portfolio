...
const Contact: React.FC<ContactProps> = ({ lang, t }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Standard mailto link is the most reliable cross-platform transmission method
    ...
    <div className="max-w-6xl mx-auto px-6">
      <div className="grid lg:grid-cols-12 gap-20">
        <div className="lg:col-span-5">
          ...
          <h3 className="text-5xl font-bold text-slate-950 mb-10 leading-none tracking-tighter">{t.title}</h3>
          ...
          <div className="space-y-12">
            <div className="flex items-center gap-8 group/item">
              <div className="w-12 h-12 bg-slate-50 group-hover/item:bg-indigo-600 group-hover/item:text-white rounded-2xl flex items-center justify-center shrink-0 border border-slate-100 transition-all duration-300">
                <Mail size={20} className="text-indigo-600 group-hover/item:text-white" />
              </div>
              <div className="flex-grow">
                <h4 className="font-black text-slate-400 mb-1 uppercase tracking-[0.3em] text-[8px]">{t.labels.email}</h4>
                <div className="flex items-center gap-3">
                  <a href="mailto:cLiu@carolcga.ca" className="text-slate-950 font-black text-sm tracking-tight hover:text-indigo-600 transition-colors">cLiu@carolcga.ca</a>
                  <button 
                    onClick={copyEmail}
                    className="p-1.5 hover:bg-slate-100 rounded-lg text-slate-400 hover:text-indigo-600 transition-all flex items-center gap-2"
                    title="Copy Email"
                  >
                    <Copy size={12} />
            ...
            <div className="flex items-center gap-8 group/item">
              <div className="w-12 h-12 bg-slate-50 group-hover/item:bg-indigo-600 group-hover/item:text-white rounded-2xl flex items-center justify-center shrink-0 border border-slate-100 transition-all duration-300">
                <Phone size={20} className="text-indigo-600 group-hover/item:text-white" />
              </div>
              <div>
                <h4 className="font-black text-slate-400 mb-1 uppercase tracking-[0.3em] text-[8px]">{t.labels.phone}</h4>
                <a href="tel:6047205690" className="text-slate-950 font-black text-sm tracking-tight hover:text-indigo-600 transition-colors">604.720.5690</a>
              </div>
            </div>

            <div className="flex items-center gap-8 group/item">
              <div className="w-12 h-12 bg-slate-50 group-hover/item:bg-indigo-600 group-hover/item:text-white rounded-2xl flex items-center justify-center shrink-0 border border-slate-100 transition-all duration-300">
                <MapPin size={20} className="text-indigo-600 group-hover/item:text-white" />
              </div>
              <div>
                <h4 className="font-black text-slate-400 mb-1 uppercase tracking-[0.3em] text-[8px]">{t.labels.hq}</h4>
                <p className="text-slate-950 font-black text-sm tracking-tight leading-tight max-w-[200px]">21471 90 Ave Langley BC. Canada V1M 1Z2</p>
              </div>
            </div>
          </div>
        </div>

        <div className="lg:col-span-7 bg-white p-10 lg:p-16 rounded-[4rem] shadow-[0_50px_100px_-30px_rgba(0,0,0,0.1)] border border-slate-50 relative overflow-hidden">
          ...
          <form ref={formRef} onSubmit={handleSubmit} className="space-y-10 relative z-10">
            <div className="grid md:grid-cols-2 gap-10">
              <div className="space-y-4">
                ...
                <input 
                  ...
                  name="name"
                  type="text" 
                  className="w-full bg-slate-50 border border-slate-100 rounded-2xl px-8 py-5 focus:outline-none focus:ring-4 focus:ring-indigo-600/5 focus:bg-white transition-all font-bold text-slate-950 text-sm placeholder:text-slate-300" 
            ...
            <div className="space-y-4">
              ...
              <textarea 
                ...
                name="message"
                rows={4} 
                className="w-full bg-slate-50 border border-slate-100 rounded-3xl px-8 py-6 focus:outline-none focus:ring-4 focus:ring-indigo-600/5 focus:bg-white transition-all resize-none font-bold text-slate-950 text-sm placeholder:text-slate-300" 
