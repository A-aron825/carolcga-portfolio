    ...
    <footer className="bg-slate-950 text-white pt-24 pb-12">
      <div className="w-full max-w-7xl mx-auto px-6 md:px-12 lg:px-16">
        <div className="grid md:grid-cols-4 gap-16 mb-24">
          <div className="col-span-2">
            <button onClick={(e) => scrollToSection(e, 'home')} className="inline-block mb-10 text-left group">
              <span className="text-3xl font-black tracking-tighter serif group-hover:text-indigo-400 transition-colors">CAROL LIU</span>
              <span className="block text-[9px] tracking-[0.5em] text-slate-500 uppercase font-black mt-2 group-hover:text-slate-400 transition-colors">CPA • CGA {navT.corp}</span>
            </button>
            ...
            <div className="flex gap-4">
              <a 
                ...
                className="w-12 h-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-white hover:text-slate-950 transition-all duration-500 hover:shadow-[0_0_20px_rgba(255,255,255,0.2)]"
              >
                <Linkedin size={20} />
              </a>
              <a href="mailto:cLiu@carolcga.ca" aria-label="Send email to Carol Liu" className="w-12 h-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-white hover:text-slate-950 transition-all duration-500 hover:shadow-[0_0_20px_rgba(255,255,255,0.2)]">
                <Mail size={20} />
              </a>
            </div>
          </div>
          ...
          <div>
            <h4 className="font-black uppercase tracking-[0.4em] text-[9px] mb-12 text-indigo-400">{t.directory}</h4>
            <ul className="space-y-6">
              {[
                ...
                <li key={item.id}>
                  ...
                  >
                    <span className="h-0.5 w-0 bg-indigo-500 transition-all group-hover:w-4 mr-0 group-hover:mr-3 rounded-full"></span>
                    {item.label}
                  </button>
                </li>
              ))}
          ...
          <div>
            <h4 className="font-black uppercase tracking-[0.4em] text-[9px] mb-12 text-indigo-400">{t.legal}</h4>
            <ul className="space-y-6">
              {legalItems.map((item) => (
                <li key={item.id}>
                  <button 
        ...
        <div className="pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          >
            {t.ascend}
            <div className="w-12 h-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center group-hover:bg-indigo-600 group-hover:border-indigo-600 group-hover:shadow-[0_0_25px_rgba(79,70,229,0.4)] transition-all">
              <ArrowUp size={18} />
            </div>
          </button>
        </div>
